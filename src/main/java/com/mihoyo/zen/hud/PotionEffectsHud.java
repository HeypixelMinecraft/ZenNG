...
import com.mihoyo.zen.utils.math.Easings;
import com.mihoyo.zen.utils.render.ColorUtil;
...
extends HudElement {
    public static final class EffectEntry {
        ...
        public void show(float targetHeight) {
            this.heightAnim.animate(1.0, 0.3, Easings.EASE_OUT_POW3);
            this.widthAnim.animate(targetHeight, 0.3, Easings.EASE_OUT_POW3);
        }

        public void startRemove() {
            if (this.removing) return;
            this.removing = true;
            this.heightAnim.animate(0.0, 0.2, Easings.EASE_IN_POW3);
            this.widthAnim.animate(0.0, 0.2, Easings.EASE_IN_POW3);
        }
