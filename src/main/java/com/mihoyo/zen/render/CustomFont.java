...
implements Closeable {
    ...
    public void drawStringColor(PoseStack poseStack, String text, double x, double y, Color color) {
        this.drawStringRGB(poseStack, text, (float)x, (float)y, (float)color.getRed() / 255.0f, (float)color.getGreen() / 255.0f, (float)color.getBlue() / 255.0f, (float)color.getAlpha() / 255.0f);
    }
    ...
    public void drawStringRainbow(PoseStack poseStack, String text, float x, float y, int offset) {
        this.drawStringRGBFull(poseStack, text, x, y, 1.0f, 1.0f, 1.0f, 1.0f, true, offset);
    }
